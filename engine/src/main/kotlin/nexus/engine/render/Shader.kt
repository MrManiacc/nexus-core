...
Unbind the shader, called when we are done writing.
    ...
    /*This should update a float to the shader**/
    abstract fun uploadTexture(uniform: String, texture: TextureInstance, slot: Int)

    /*This should update a float to the shader**/
    fun uploadTexture(uniform: String, texture: TextureInstance) {
        uploadTexture(uniform, texture, texture.slot)
    }
