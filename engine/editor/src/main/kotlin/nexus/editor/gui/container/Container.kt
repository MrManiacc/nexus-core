...
interface Container : Node {
     ...
     */
    fun <T : Node> findRecursive(type: KClass<T>): List<T>
     ...
     *  level children.
     */
    fun <T : Node> findRecursive(name: String, type: KClass<T>): T?

    /**
     * This is used to check if we have a code of the given type. This is non recursive
     */
    fun <T : Node> contains(type: KClass<T>): Boolean
     ...
     */
    fun <T : Node> containsRecursive(type: KClass<T>): Boolean
     ...
     */
    fun <T : Node> contains(type: KClass<T>, name: String): Boolean

    /**
     * This is used to determine if we have a node assignable of the given [type]
     * and with the name id of the given [name].
     */
    fun <T : Node> containsRecursive(type: KClass<T>, name: String): Boolean
