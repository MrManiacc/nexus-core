 ...
 */
abstract class ContainerNode(id: String, flags: Array<out WindowFlag>) : BaseNode(id, flags), MutableContainer,
    Iterable<Node> {
    protected val children: MutableMap<ID, Node> = HashMap()
     ...
     */
    override fun add(element: Node, forceReplace: Boolean): Boolean {
     ...
     */
    override fun remove(id: ID): Node? {
     ...
     */
    override fun <T : Node> removeAll(type: KClass<T>): Collection<T> {
     ...
     */
    override fun <T : Node> find(name: String, type: KClass<T>): T? {
    ...
    override fun <T : Node> find(type: KClass<T>): List<T> {
     ...
     */
    override fun <T : Node> findRecursive(type: KClass<T>): List<T> {
     ...
     *  level children.
     */
    override fun <T : Node> findRecursive(name: String, type: KClass<T>): T? {
        for (child in children.values) {
            if (type.isInstance(child)) {
     ...
     */
    override fun <T : Node> contains(type: KClass<T>): Boolean {
     ...
     */
    override fun <T : Node> contains(type: KClass<T>, name: String): Boolean {
     ...
     */
    override fun <T : Node> containsRecursive(type: KClass<T>): Boolean {
     ...
     * and with the name id of the given [name].
     */
    override fun <T : Node> containsRecursive(type: KClass<T>, name: String): Boolean {
     ...
     */
    override fun iterator(): MutableIterator<Node> = children.values.iterator()
