...
import nexus.editor.api.theme.Colors
...
class DebugRenderAPI(
    ...
    /*This stores the nexus.plugins.glfw backend implementation for imgui**/
...
//        setColor(ImGuiCol.FrameBgActive, ImVec4(0.56f, 0.56f, 0.58f, 1.00f))
        setColor(ImGuiCol.TitleBg, Colors.color("#282a36"))
        setColor(ImGuiCol.TitleBgCollapsed, Colors.color("#44475a"))
        setColor(ImGuiCol.TitleBgActive, Colors.color("#44475a"))
        setColor(ImGuiCol.MenuBarBg, Colors.color("#282a36"))
