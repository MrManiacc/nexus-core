...
import nexus.engine.assets.old.AssetInstanceOld
import nexus.engine.assets.texture.*
import nexus.plugins.opengl.data.IOUtil
...
class GLTexture2D : Texture2D() {
     ...
     */
    override fun instantiate(data: TextureData): AssetInstanceOld<Texture, TextureData> {
        val texture =
